...
def participant_state_after(message: str) -> str:
    ...
    mapping = {"CAN_COMMIT": "WAITING", "PRE_COMMIT": "PRECOMMITTED", "DO_COMMIT": "COMMITTED", "ABORT": "ABORTED"}
...
if __name__ == "__main__":
    assert three_phase_commit({"A": True, "B": True}) == ("COMMIT", ["CAN_COMMIT", "PRE_COMMIT", "DO_COMMIT"])
    assert three_phase_commit({"A": True, "B": False}) == ("ABORT", ["CAN_COMMIT", "ABORT"])
