...
def fifo_page_replacement(references: list[int], frame_count: int) -> tuple[int, list[PageEvent]]:
...
if __name__ == "__main__":
    ...
    assert faults == 5
    assert [event.hit for event in events] == [False, False, False, True, False, True, False]
