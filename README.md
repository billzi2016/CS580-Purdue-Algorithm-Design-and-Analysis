...
> [!WARNING]
> Disclaimer: This project is provided as is and is only intended for personal learning, coursework practice, and engineering organization. It is not affiliated with Purdue University and does not represent Purdue University course requirements, teaching materials, or official positions. The code may contain mistakes, omissions, or incomplete design considerations; although testing and validation are performed, they may not be comprehensive, so no warranty is made regarding correctness, completeness, fitness for purpose, or consequences of use.
